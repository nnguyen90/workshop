...
- **operator bool**<br />
returns **true** if the apartment number is **valid**; otherwise, it returns **false**. This operator cannot modify the **apartment** object.
- **operator int**<br />
...
- **bool operator ~()**<br />
This operator returns **true** if the **apartment** is  **not valid**; otherwise, it will return **false**.  This operator cannot modify the **apartment** object.
...
```
- overload the **assignment operator** so an **apartment** can be set to another **apartment** object. This action should **move** the rent balance and the apartment number of one apartment to another. Therefore, unlike the usual assignment operator that affects the left operand only, this operator will affect both operands; the rent balance of the left apartment will be set to the balance of the right apartment and then the balance of the right apartment will be set to zero. The same will happen to the apartment number<br />
In any case, a reference of the **current object** (**apartment**) should be returned. 
```C++
...
- overload the **<< operator** (left shift operator) to move the balance from the right apartment to the left apartment. After this operation, the balance of the left apartment account will be the sum of both the left and right apartment, and the balance of the right apartment account will be zero. The right apartment's apartment number does not change.<br />
...
- overload the **>> operator** (right shift operator) to move the balance from the left apartment to the right apartment. After this operation, the balance of the right apartment account will be the sum of both the right and left apartment and the balance of the left apartment account will be zero. The left apartment's account number does not change.<br />
...
The value of the rent balance of the right operand (apartment reference) should be added to the left operand (double reference) <br />
Then, the updated value of the double reference is returned. 
